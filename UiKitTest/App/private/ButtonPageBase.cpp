	...
	: Page(pParent)
{
    ...
    pElement1->AddElement(pElement2);
        ...
        pElement2->SetAlignItemsHor((e3::EAlignment)0);
                UiButtonDefault* pCustomView4 = new UiButtonDefault();
        pElement2->AddElement(pCustomView4);
        pCustomView4->SetText("BUTTON");
                UiText* pCustomView5 = new UiText();
        pElement1->AddElement(pCustomView5);
        pCustomView5->SetMarginTop("30dp");
        pCustomView5->SetFontStyle((e3::EFontStyle)16);
        pCustomView5->SetText("A Button with graphical content.");
        pCustomView5->SetFontSize("18dp");
    ...
    pElement1->AddElement(pElement3);
        ...
        pElement3->SetAlignItemsHor((e3::EAlignment)0);
                UiButton* pCustomView6 = new UiButton();
        pElement3->AddElement(pCustomView6);
        pCustomView6->SetWidth("50dp");
        pCustomView6->SetHeight("50dp");
    e3::Element* pElement4 = e3::ViewFactory::CreateShape( e3::EOrientation::Horizontal);
    pCustomView6->AddElement(pElement4);
        ...
        pCustomView7->SetFontStyle((e3::EFontStyle)16);
        pCustomView7->SetText("Accent style applied to Button.");
        pCustomView7->SetFontSize("18dp");
    ...
    pElement1->AddElement(pElement5);
        ...
        pElement5->SetAlignItemsHor((e3::EAlignment)0);
                UiButtonDefault* pCustomView8 = new UiButtonDefault();
        pElement5->AddElement(pCustomView8);
        pCustomView8->SetStyle(UiAccent);
        pCustomView8->SetText("Standart Ui Button");
