#include "CalendarDatePickerPageBase.h"

#include <e3/ViewFactory.h>
#include "UiKitTestValues.h"

CalendarDatePickerPageBase::CalendarDatePickerPageBase(e3::Element* pParent)
	: Page(pParent)
{
        this->SetWidth("100%");
        this->SetHeight("100%");
    ...
    AddElement(pElement1);
        ...
        pCustomView1->SetText("CalendarDatePicker");
    ...
    pElement1->AddElement(pElement2);
        ...
        pElement2->SetAlignItemsHor((e3::EAlignment)0);
                UiCalendarDatePicker* pCustomView4 = new UiCalendarDatePicker();
