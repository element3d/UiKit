	...
	: Page(pParent)
{
    ...
    AddElement(pElement1);
        ...
        pElement1->AddElement(pCustomView4);
                UiExpander* pCustomView5 = new UiExpander();
        pCustomView4->AddElement(pCustomView5);
                UiExpanderHeaderDefault* pCustomView6 = new UiExpanderHeaderDefault();
        pCustomView5->AddElement(pCustomView6);
        pCustomView6->SetTitle(_s(This is header text));
                UiExpanderBody* pCustomView7 = new UiExpanderBody();
        pCustomView5->AddElement(pCustomView7);
        pCustomView7->SetWidth("100%");
        pCustomView7->SetHeight("100dp");
        pCustomView7->SetBorderSize("1dp");
        pCustomView7->SetBorderColor(glm::vec4(220, 220, 220, 255));
                UiText* pCustomView8 = new UiText();
        pCustomView7->AddElement(pCustomView8);
        pCustomView8->SetText("This is in the content");
