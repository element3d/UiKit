	...
	: Page(pParent)
{
    ...
    AddElement(pElement1);
        ...
        pCustomView2->SetText("Use a Slider when you want your users to be able to set defined, contiguous value (such as volume or brightness) or a range of discrete values (such as screen resolution settings).");
        ...
        pCustomView3->SetText("A simple Slider.");
    ...
    pElement1->AddElement(pElement2);
        ...
        pElement2->SetOrientation((e3::EOrientation)1);
                UiSlider* pCustomView4 = new UiSlider();
